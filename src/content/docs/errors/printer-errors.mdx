---
title: Sửa lỗi máy in
description: Chẩn đoán, xử lý nhanh các sự cố chia sẻ và kết nối máy in trong mạng nội bộ, dọn dẹp driver in ấn.
---
...
<Screenshot 
  src="/images/hyperlis/errors/printer-repair-01.png" 
  alt="Giao diện tab Sửa lỗi (Errors)"
/>

## 2. Các mã lỗi chia sẻ máy in hỗ trợ
