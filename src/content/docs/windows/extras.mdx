---
title: Mở rộng
description: Tùy biến Snap Assist, menu chuột phải cổ điển, hiện đuôi file, chế độ thu gọn và NumLock khi khởi động.
---
...
## 5. Bật chế độ thu gọn trong Explorer
