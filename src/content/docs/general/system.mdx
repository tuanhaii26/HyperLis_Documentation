---
title: Hệ thống
description: Tinh chỉnh hiệu suất hệ thống, tối ưu hóa hiển thị, tắt báo cáo lỗi, SmartScreen và quản lý dịch vụ Windows.
---
...
## 5. Tắt tối ưu hóa chế độ toàn màn hình
...
## 9. Cài đặt hiển thị cho hiệu suất
