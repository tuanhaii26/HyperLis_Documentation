---
title: Ứng dụng
description: Vô hiệu hóa thu thập dữ liệu phân tích và telemetry từ các phần mềm phổ biến như Office, Chrome, NVIDIA, Brave, Edge và Visual Studio.
---
...
## 7. Tắt theo dõi từ Visual Studio
