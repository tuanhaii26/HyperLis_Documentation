---
title: Sửa lỗi Windows
description: Chẩn đoán và khắc phục tự động các sự cố thường gặp trên hệ điều hành Windows, sửa file hệ thống, lỗi mạng và giao diện.
---
...
<Screenshot 
  src="/images/hyperlis/errors/windows-repair-01.png" 
  alt="Giao diện tab Sửa lỗi (Errors)"
/>

## 2. Danh sách các công cụ sửa lỗi và chẩn đoán
